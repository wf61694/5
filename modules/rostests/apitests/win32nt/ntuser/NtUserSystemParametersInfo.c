...
Test_UserPref(UINT uiGet, UINT uiSet, DWORD dwPrefMask)
{
    ...
    NtUserSystemParametersInfo(uiSet, 0, (PVOID)(LONG_PTR)bOrig, SPIF_UPDATEINIFILE);
...
Test_SPI_SETMENUANIMATION(void)
{
    ...
    /* Restore original values */
    NtUserSystemParametersInfo(SPI_SETMENUANIMATION, 0, (PVOID)(LONG_PTR)bOrig, SPIF_UPDATEINIFILE);
}
