 ...
 */
MMRESULT WINAPI midiOutMessage(HMIDIOUT hMidiOut, UINT uMessage,
 ...
 * 				midiInMessage		[WINMM.@]
 */
MMRESULT WINAPI midiInMessage(HMIDIIN hMidiIn, UINT uMessage,
                          DWORD_PTR dwParam1, DWORD_PTR dwParam2)
{
    LPWINE_MLD		wmld;
 ...
 */
MMRESULT WINAPI waveOutMessage(HWAVEOUT hWaveOut, UINT uMessage,
                           DWORD_PTR dwParam1, DWORD_PTR dwParam2)
{
    LPWINE_MLD		wmld;
 ...
 * 				waveInMessage 		[WINMM.@]
 */
MMRESULT WINAPI waveInMessage(HWAVEIN hWaveIn, UINT uMessage,
                          DWORD_PTR dwParam1, DWORD_PTR dwParam2)
{
    LPWINE_MLD		wmld;
